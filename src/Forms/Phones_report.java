 ...
 * @author Ahmed
 */
public class Phones_report extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        String Query = "select * from EmployeePhonesData ";
        MysqlDatabaseManager.fillTable(Query, DateTable);
    ...
    private void customButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customButton9ActionPerformed
        String search = "select * from EmployeePhonesData where ";
        if (rad1.isSelected()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Phones_report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Phones_report().setVisible(true);
            }
        });
    }
